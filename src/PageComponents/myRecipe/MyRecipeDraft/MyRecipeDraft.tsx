...
export type DraftDataType = {  
    ...
    createdAt: Date, // i don't know if this should be a date or string
    updatedAt: Date,
}
...
const MyRecipeDraft = () => {
    ...
    const { draftData, deleteDraft, uploadDraft, handleSearch } = useDraft()

    if(!draftData) return <DraftSkeleton />
